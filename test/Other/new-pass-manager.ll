...
; CHECK-REPEAT-CGSCC-PASS-NEXT: Running analysis: CallGraphAnalysis
; CHECK-REPEAT-CGSCC-PASS-NEXT: Starting llvm::CallGraphSCC pass manager run.
; CHECK-REPEAT-CGSCC-PASS-NEXT: Running pass: RepeatedPass
; CHECK-REPEAT-CGSCC-PASS-NEXT: Starting llvm::CallGraphSCC pass manager run.
; CHECK-REPEAT-CGSCC-PASS-NEXT: Running pass: NoOpCGSCCPass
; CHECK-REPEAT-CGSCC-PASS-NEXT: Finished llvm::CallGraphSCC pass manager run.
; CHECK-REPEAT-CGSCC-PASS-NEXT: Starting llvm::CallGraphSCC pass manager run.
; CHECK-REPEAT-CGSCC-PASS-NEXT: Running pass: NoOpCGSCCPass
; CHECK-REPEAT-CGSCC-PASS-NEXT: Finished llvm::CallGraphSCC pass manager run.
; CHECK-REPEAT-CGSCC-PASS-NEXT: Starting llvm::CallGraphSCC pass manager run.
...
; CHECK-REPEAT-CGSCC-PASS-NEXT: Finished llvm::CallGraphSCC pass manager run.
; CHECK-REPEAT-CGSCC-PASS-NEXT: Finished llvm::CallGraphSCC pass manager run.
; CHECK-REPEAT-CGSCC-PASS-NEXT: Invalidating analysis: CallGraphAnalysis
...
; CHECK-REPEAT-LOOP-PASS-NEXT: Running analysis: ParentIRUnitTrackingAnalysisModel
